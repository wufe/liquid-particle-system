...
import { RecursivePartial, getDefault, BaseParticleSystem, IParticleSystem, Particle, TRandomizeOptions, randomValueFromBoundary, Vector3D, TransitionEasingFunction } from '@wufe/particles';
